...
public class Ex10_3 {
    ...
    public static void main(String[] args) {
        ...
        time2.set(Calendar.SECOND, 10); // time2: 20시 30분 10초

        System.out.println(time2.HOUR_OF_DAY);
        System.out.println(time2.get(Calendar.HOUR_OF_DAY));
